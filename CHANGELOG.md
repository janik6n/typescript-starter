...
- Dependabot instructed not to ignore `eslint` versions `>=10.0` anymore.
...
- Npm dependencies updated.
- Exact version pinning for npm dependencies.
- Updated container Node.js version from 22.14.0 > 22.19.0.
- GitHub Actions action version updates.
...
- Updated Node.js Docker image version.
- Updated npm dependencies.
- Few TypeScript configuration changes.
